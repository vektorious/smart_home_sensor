...
4. Select **Tools ▸ Board ▸ ESP32 Arduino ▸ ESP32-C6 Dev Module**.
5. Set **Tools ▸ USB CDC On Boot ▸ Enable**. The ESP32-C6 uses native USB — without this the Serial Monitor won't receive output during boot and the port may not appear reliably.
...
> **Getting back in later.** Press **RESET twice in quick succession** — the display tells you when the window is open. This is how you can change the broker address, move the device to a new network, or recalibrate, without reflashing.
>
